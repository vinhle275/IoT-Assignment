\subsection{Kết luận}
Sau quá trình thực hiện dự án, nhóm đã xây dựng thành công một hệ thống IoT hoàn chỉnh trên nền tảng vi điều khiển ESP32. Kết quả đạt được cho thấy sự kết hợp hiệu quả giữa các kỹ thuật lập trình nhúng hiện đại và khả năng kết nối điện toán đám mây. Các thành tựu chính của dự án bao gồm:
\begin{itemize}
