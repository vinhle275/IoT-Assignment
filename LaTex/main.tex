...
\subsection{Task 1: Đồng bộ hóa LED và cảm biến}
\input{contents/Task1.tex}

\subsection{Task 2: Thu thập và xử lý dữ liệu cảm biến}

\subsection{Task 3: Giao tiếp Dashboard và điều khiển thiết bị}

\subsection{Task 4: Tích hợp mô hình trí tuệ nhân tạo}

\subsection{Task 5: Thiết kế và cấu hình Gateway}

\subsection{Task 6: Phát triển giao diện người dùng}
