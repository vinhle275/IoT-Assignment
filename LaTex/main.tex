...
\fancyhead[L]{
    \begin{tabular}{ll}
        \begin{picture}(10,10)
            \put(0,-7){\includegraphics[width=8mm]{pictures/hcmut.png}}
        \end{picture}&
        \begin{tabular}{l}
...
\input{contents/Giới thiệu chung.tex}


\section{Thiết kế hệ thống}
\input{contents/Thiết kế hệ thống.tex}


\section{Triển khai các Task}
\subsection{Task 1,2, 3: Thu thập dữ liệu và trực quan hóa}
\input{contents/Task123.tex}

\subsection{Task 4: Web Server ở chế độ Access Point}
\input{contents/Task4.tex}

\subsection{Task 5: Huấn luyện và triển khai TinyML}
\input{contents/Task5.tex}

\subsection{Task 6: Gửi dữ liệu lên máy chủ CoreIOT Cloud}
\input{contents/Task6.tex}
...
\input{contents/Result41.tex}
\subsection{Đánh giá độ chính xác của TinyML}
\input{contents/Result42.tex}
\subsection{Kết quả kiểm thử}
\input{contents/Result43.tex}

\section{Kết luận và Hướng phát triển}
\input{contents/Kết luận và Hướng phát triển.tex}

\section*{Link Github:}
\href{https://github.com/vinhle275/IoT-Assignment}{https://github.com/vinhle275/IoT-Assignment}
